...
tool_retry_decay_interval=0 # drop one retry every N global steps

# wandb
project_name=Open-CLEANER
experiment_name=Qwen3-4B-notool
default_local_dir=output/$experiment_name
resume_dir=Qwen3-4B/global_step_80
...
if [ ! -d "$VAL_SAVE_PATH" ]; then
    ...
    data.custom_cls.name=CustomRLHFDataset_notool \
